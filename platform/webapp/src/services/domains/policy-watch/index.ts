 ...
 * PolicyWatch Domain
 *
 * Barrel export for policy-watch service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { policy-watchService } from './policy-watch.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { policy-watchFacade } from './facade';
