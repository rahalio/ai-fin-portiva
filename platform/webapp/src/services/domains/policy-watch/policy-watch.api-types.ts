/**
 * PolicyWatch API Types
 *
 * API contract types come from @portiva/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @portiva/core)
// ============================================================================
...
export type {
  // Add types from @portiva/core/policy-watch
} from "@portiva/core";

// Re-export with alias for backward compatibility if needed
// export type CorePolicyWatchItem = PolicyWatchItem;
