/**
 * Overlap Services - Application Layer Export
 *
...
/**
 * Overlap Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for overlap domain.
 */
