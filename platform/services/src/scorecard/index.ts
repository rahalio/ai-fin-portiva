/**
 * Scorecard Services - Application Layer Export
 *
...
/**
 * Scorecard Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for scorecard domain.
 */
